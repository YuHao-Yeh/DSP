...
numiters=9                                     # Number of iterations of training
maxiterinc=8                                   # Last iter to increase #Gauss on.
numgauss=9000                                    # Initial num-Gauss (must be more than #states=3*phones).
totgauss=25000                                  # Target #Gaussians.
